...
export function ProductCard({ name, price, size, image, category }: ProductCardProps) {
  ...
  return (
    <div
      className="product-card group bg-card rounded-xl overflow-hidden shadow-soft hover:shadow-soft-xl border border-border"
      data-aos="zoom-in"
    >
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        />
        {category && (
          <span className="absolute top-4 left-4 bg-primary/95 backdrop-blur-sm text-primary-foreground text-xs font-bold px-3 py-1.5 rounded-full">
            {category}
          </span>
        )}
      ...
      <div className="p-6">
        ...
        <Button
          asChild
          className="w-full bg-primary hover:bg-gold-dark text-primary-foreground gap-2 font-semibold py-6 h-auto"
        >
